...
#起飞携带燃油质量 [kg]
dt = 5  #时间步长 [s]
capacity = 8100#电池容量 [Wh] 需要与电池类所在的脚本里的参数保持一致
Ub = 60 #动力电路电压 [V]
Height = 200 #定高飞行
Height_2nd = 700
theta = 5
...
while case.h < Height:
    ...
    Bat_stat_rule.append([case.powerSys.get_Bat_heat(), case.powerSys.get_I_bat()])
...
#     t.append(case.t)
#     flight_stat_rule.append(
#         [case_rule.u, case_rule.v, case_rule.powerSys.fuelMass, case_rule.distance, case_rule.h, case_rule.powerSys.SoC, case_rule.ESC.get_ESC_power(),
#          case_rule.powerSys.get_ge_power()])
#
#     Bat_stat.append([case.powerSys.get_Bat_heat(), case.powerSys.get_I_bat()])
#     Bat_stat_rule.append([case.powerSys.get_Bat_heat(), case.powerSys.get_I_bat()])
#     Hf_t.append(case.t)
...
while case.powerSys.get_fuelmass()>0.5 and case.t<1900:
    ...
    Bat_stat.append([case.powerSys.get_Bat_heat(), case.powerSys.get_I_bat()])
    Bat_stat_rule.append([case_rule.powerSys.get_Bat_heat(), case.powerSys.get_I_bat()])
    Hf_t.append(case.t)
